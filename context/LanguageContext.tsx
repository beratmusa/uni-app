...
const translations = {
  ...
  uniName: "KASTAMONU ÜNİVERSİTESİ",
  idSuffix: "Kimliği", // Örn: ÖĞRENCİ KİMLİĞİ
  studentIdLabel: "Öğrenci",
  staffIdLabel: "Personel",
  studentNo: "Öğrenci No",
  staffNo: "Sicil No",
